...
namespace RowerPower.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        private readonly IRepository<VehicleTypeModel, int> vehicleTypeRepo;
        private readonly IMapper mapper;

        public VehiclesController(IRepository<VehicleModel, int> vehicleRepository, IRepository<VehicleTypeModel, int> vehicleTypeRepository, IMapper mapper) {
